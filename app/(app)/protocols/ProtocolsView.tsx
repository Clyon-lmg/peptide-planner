...
export default function ProtocolsView({ 
    ...
    const selectedProtocol = initialProtocols.find(p => p.id === selectedId);
            ...
            <div className={`w-full md:w-80 border-r border-border bg-card/30 flex flex-col ${selectedId ? 'hidden md:flex' : 'flex'}`}>
                ...
                <div className="p-4 border-b border-border space-y-3">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-muted-foreground bg-muted/50 px-2 py-1 rounded-full">{initialProtocols.length}</span>
                    </div>
